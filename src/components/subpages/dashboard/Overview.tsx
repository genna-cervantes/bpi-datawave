      ...
      <div className="px-1 grid grid-cols-4 gap-x-3">
        ...
        <div className="border rounded-md px-3 py-3">
          ...
          <div className="mt-3">
                ...
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push(
                          "/assistant?message=How to compute current cash balance?"
                        );
                      }}
            ...
            <p className="text-xs">
              +<span className="font-semibold text-green-500">2.1%</span> from
              last month
            </p>
          </div>
        </div>
        ...
        <div className="border rounded-md px-3 py-3">
          ...
          <div className="mt-3">
                ...
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push(
                          "/assistant?message=How to compute monthly burn?"
                        );
                      }}
                      className="cursor-pointer bg-gray-200 text-xs mb-2 px-2 py-1 rounded-sm"
                    >
            ...
            <p className="text-xs">
              +<span className="font-semibold text-red-500">5.1%</span> from
              last month
            </p>
          </div>
        </div>
        ...
        <div className="border rounded-md px-3 py-3">
          ...
          <div className="mt-3">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push("/assistant?message=How to compute MRR?");
                      }}
                      className="cursor-pointer bg-gray-200 text-xs mb-2 px-2 py-1 rounded-sm"
                    >
                      Ask AI
            ...
            <p className="text-xs">
              +<span className="font-semibold text-green-500">12.3%</span> from
              last month
            </p>
          </div>
        </div>
                ...
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push(
                          "/assistant?message=How to compute runway?"
                        );
                      }}
                      className="cursor-pointer bg-gray-200 text-xs mb-2 px-2 py-1 rounded-sm"
                    >
      ...
      <div className="grid grid-cols-3 gap-x-3 px-1">
        ...
        <div className="border rounded-md px-3 py-3">
          ...
          <div className="mt-3">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push("/assistant?message=How to compute ARR?");
                      }}
                      className="cursor-pointer bg-gray-200 text-xs mb-2 px-2 py-1 rounded-sm"
                    >
                      Ask AI
            ...
            <p className="text-xs">
              +<span className="font-semibold text-green-500">5.1%</span> from
              last month
            </p>
          </div>
        </div>
        ...
        <div className="border rounded-md px-3 py-3">
          ...
          <div className="mt-3">
            <span className="flex items-center gap-x-2">
              <h1 className="text-lg font-bold">
                {formatNumber(data.ltv / data.cac, 1)}:1
              </h1>
              <TooltipProvider>
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push(
                          "/assistant?message=How to compute LTV:CAC?"
                        );
                      }}
                      className="cursor-pointer bg-gray-200 text-xs mb-2 px-2 py-1 rounded-sm"
                    >
        ...
        <div className="border rounded-md px-3 py-3">
          ...
          <div className="mt-3 flex flex-col items-start">
            <span className="gap-x-2 flex items-center">
              <h1 className="text-lg font-bold">
                {formatNumber(data.payback_period, 1)} Months
              </h1>
              <TooltipProvider>
                <Tooltip>
                  <TooltipContent>
                    <button
                      onClick={() => {
                        router.push(
                          "/assistant?message=How to compute payback period?"
                        );
                      }}
                      className="cursor-pointer bg-gray-200 text-xs mb-2 px-2 py-1 rounded-sm"
                    >
            ...
            <p className="text-xs px-2 bg-green-300 rounded-sm border border-green-500">
              Healthy
            </p>
          </div>
        </div>
